...
tags: ["전자기학", "전기", "전하", "맥스웰 방정식", "가우스 법칙", "전기장", "중첩 원리", "도체"]
math: true
toc: true
comments: true
---
...
$$\displaystyle \oint_{C} \vec{E} \cdot d \vec{r} = E^{\mid\mid}_{above}l - E^{\mid\mid}_{below}l = 0 \implies  ~ E^{\mid\mid}_{above} - E^{\mid\mid}_{below}= 0$$
