...
date: "2025-01-03"
categories: []
tags: ["알고리즘", "그리디", "최소 신장 트리", "크루스칼 알고리즘", "프림 알고리즘", "다익스트라 알고리즘", "작업 스케줄링", "기댓값"]
math: true
toc: true
comments: true
---
...
![image](/assets/img/posts/Pasted-image-20240914174618.png)
> 
> $V_{0}$ 노드에서 시작하자. 아무 노드에서 시작해도 된다.
> 
> ![image](/assets/img/posts/Pasted-image-20240914175349.png)
> 
...
![Pasted image 20241003163745.png](/assets/img/posts/Pasted image 20241003163745.png)
