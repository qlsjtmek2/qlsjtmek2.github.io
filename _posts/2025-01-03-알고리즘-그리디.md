...
date: "2025-01-03"
categories: []
tags: ["알고리즘", "그리디", "최소 신장 트리", "크루스칼", "프림", "다익스트라", "작업 스케줄링", "우선순위 큐"]
math: true
toc: true
comments: true
---
...
> 
> ![image](Utilities/Reference Files/Pasted image 20240914174618.png){: width="400"}
> 
> $V_{0}$ 노드에서 시작하자. 아무 노드에서 시작해도 된다.
> 
> ![image](Utilities/Reference Files/Pasted image 20240914175349.png){: width="400"}
> 
> 처음엔 두 엣지 $E_{1}, E_{2}$중 하나를 고를 수 있다. $E_{1}$가 가장 Weight가 작고, 싸이클을 만들지 않으므로 $T$에 $E_{1}$을 추가한다. $T = \{E_{1}\}$
> 
> ![image](Utilities/Reference Files/Pasted image 20240914175403.png){: width="400"}
> 
> $E_{2}, E_{3}, E_{4}$중 하나를 골라야 한다. $E_{3}$이 가장 작고, 싸이클을 만들지 않으므로 $E_{3}$ 엣지를 $T$에 추가한다. $T = \{E_{1}, E_{3}\}$
> 
> ![image](Utilities/Reference Files/Pasted image 20240914175506.png){: width="400"}
> 
> $E_{2}, E_{4}$ 중 $E_{2}$ 엣지가 가장 Weigt가 작고, 싸이클을 만들지 않으므로 $E_{2}$ 엣지를 $T$에 추가한다. $T = \{ E_{1},  E_{3}, E_{2} \}$
> 
> ![image](Utilities/Reference Files/Pasted image 20240914175649.png){: width="400"}
> 
...
> 
> ![image](Utilities/Reference Files/Pasted image 20240914180235.png){: width="400"}
> 
...
> ![image](Utilities/Reference Files/Pasted image 20240924103322.png){: width="350"}
> 
...
> ![image](Utilities/Reference Files/Pasted image 20240924161141.png){: width="350"}
> 
> 노란색 같은 케이스는 없을까?
> 
> 만약 노란색 케이스가 있어서, Direct Edge에서 더하는 것보다 더 작은 Shorest Path를 만든다고 가정해보자.
> 
> ![image](Utilities/Reference Files/Pasted image 20240924161823.png){: width="350"}
> 
...
![image](Utilities/Reference Files/Pasted image 20241003154522.png){: width="400"}
...
![image](Utilities/Reference Files/Pasted image 20241003154901.png){: width="400"}

이 경우는 문제가 되지 않는다. 따라서 **OK**.

**Case 3-2.** S에 들어간 $J_{i}$보다 A에 들어간 $J_{i}$가 앞에 있는 경우

![image](Utilities/Reference Files/Pasted image 20241003160849.png){: width="400"}
...
![image](Utilities/Reference Files/Pasted image 20241003160043.png){: width="400"}
...
![image](Utilities/Reference Files/Pasted image 20241003162841.png){: width="350"}
...
![image](Utilities/Reference Files/Pasted image 20241003163745.png){: width="550"}

두 케이스 모두 S에 있는 $J_{x}$ 대신 $J_{i}$를 넣어도 괜찮다.

![image](Utilities/Reference Files/Pasted image 20241003163837.png){: width="550"}
