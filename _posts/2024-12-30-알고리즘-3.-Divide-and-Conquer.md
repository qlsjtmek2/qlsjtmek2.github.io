...
![[Pasted image 20241009182653.png|center|300]]
...
![image](/assets/img/2024-12-30-알고리즘-3-Divide-and-Conquer/Pasted-image-20241017105006.png){: width="600" }
...
![image](/assets/img/2024-12-30-알고리즘-3-Divide-and-Conquer/Pasted-image-20241017105103.png){: width="600" }
...
![[Pasted image 20241010103018.png|center|400]]
...
![[Pasted image 20241010092846.png|center|400]]
...
![[Pasted image 20241010092735.png|center|250]]
...
![image](/assets/img/2024-12-30-알고리즘-3-Divide-and-Conquer/Pasted-image-20241015101626.png)
...
![[Pasted image 20241015102638.png|center|300]]
...
![[Pasted image 20241015141536.png|center|600]]
...
> 
> 
> ![[Pasted image 20241015230559.png|center|400]]
> 
...
{: .prompt-tip}
> 
> ![[Pasted image 20241015231026.png|center|350]]
> 
...
{: .prompt-tip}
> 
> ![[Pasted image 20241015232414.png|center|350]]
> 
...
> 
> **왼쪽 접접**을 구할 땐, 인접한 두 점 중 왼쪽 점에서 시작하여 x좌표가 작아지는 방향으로 CCW^[Counter-Clock-Wise (CCW Algorithm)]를 진행한다.
> 
...
> 2. **접점이 한개** 생기는 경우
> 
> ![[Pasted image 20241015233041.png|center|400]]
> 
> $$x < m ~~~ || ~~~ x > M$$
> 인 경우, 접점이 한개 생긴다.
> 
...
![[Pasted image 20241015234007.jpg|center|300]]
...
![[Pasted image 20241015094025.png|center]]

> 똑같이 CCW로 찾으면 된다.
{: .prompt-tip}
> 
> ![[Pasted image 20241015235529.png|center|350]]
> 
...
> 
> ![[Pasted image 20241015235715.png|center|350]]
> 
...
> ![[Pasted image 20241016085218.png|center|350]]
> 
...
![[Pasted image 20241017215532.png|center|400]]

그다음은, 2칸씩 짝지어서 더한다.

![[Pasted image 20241017215559.png|center]]

그다음은, 4칸씩 짝지어서 더한다.

![[Pasted image 20241017215718.png|center]]
