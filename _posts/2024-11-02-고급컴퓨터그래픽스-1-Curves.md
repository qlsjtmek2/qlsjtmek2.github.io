...
> 
> 첫번째 방식이 **Explicit**, 두번째 방식이 **Implicit**, 세번째 방식이 **Parametric**.^[[Equation (방정식)#방정식의 모양](https://qlsjtmek2.github.io/[Equation-(방정식)#방정식의-모양)]
> 
...
> 2. 간격이 Uniform하지 않다.
> 
> ![Pasted image 20240915130427.png](/assets/img/posts/Pasted image 20240915130427.png){: width="300"}
> 
...
> $$x(\theta) = x_{c}+ r\cos \theta, ~~~y(\theta)= y_{c} + r\sin \theta$$
> 
> [Polar coordinate (극좌표계)](https://qlsjtmek2.github.io/Polar-coordinate-(극좌표계))를 사용한다.
> 
...
> 이 방정식에는 중요한 의미가 있다.
> 
> ![Pasted image 20240915131355.png](/assets/img/posts/Pasted image 20240915131355.png){: width="300"}
> 
> $(x, y)$ 값을 $f(x, y)$에 넣었을 때 0이 나오면 원의 테두리, +면 원의 밖, -면 원의 안쪽에 있다는 의미다.
> 
> ![Pasted image 20240915132029.png](/assets/img/posts/Pasted image 20240915132029.png){: width="300"}
> 
...
> 
> ![Pasted image 20240915133221.png](/assets/img/posts/Pasted image 20240915133221.png){: width="300"}
> 
...
> 
> ![Pasted image 20240915135650.png](/assets/img/posts/Pasted image 20240915135650.png){: width="400"}
> 
...
> 
> ![Pasted image 20240915141519.png](/assets/img/posts/Pasted image 20240915141519.png){: width="400"}
> 
...
> 
> 회전 => (x, y) 벡터에 [Rotate Matrix (회전 행렬)](https://qlsjtmek2.github.io/Rotate-Matrix-(회전-행렬)) 적용.
> 
> ```c
...
![Pasted image 20241214184835.png](/assets/img/posts/Pasted image 20241214184835.png)
...
> 
> ![Pasted image 20240920093257.png](/assets/img/posts/Pasted image 20240920093257.png){: width="500"}
> 
> - 1차 Basis Function
> 	- $B_{0,1}(u) = 1-u$
> 	- $B_{1,1}(u) = u$
...
> ![Pasted image 20241005230633.png](/assets/img/posts/Pasted image 20241005230633.png){: width="400"}
...
> 
> ![Pasted image 20240915173107.png](/assets/img/posts/Pasted image 20240915173107.png){: width="400"}
> 
...
> [!tip]- 구현 팁{title}
> 
> ![Pasted image 20240915173659.png](/assets/img/posts/Pasted image 20240915173659.png){: width="300"}
> 
...
3. **$G^2$ Continuity** : 곡률 연속성. 
	- $\displaystyle \frac{\lvert P_{1}' \times P_{1}'' \rvert}{\lvert P_{1}' \rvert^3}|_{u=1} = \frac{\lvert P_{2}' \times P_{2}'' \rvert}{\lvert P_{2}' \rvert^3}|_{u=0}$
