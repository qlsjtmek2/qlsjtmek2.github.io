...
tags: ["전자기학", "Del Operator", "미분 연산자", "스칼라 필드", "벡터 필드", "델타 함수", "미분 규칙", "물리량"]
math: true
toc: true
comments: true
---
...
$$d f(x,y,z)$$는 어떻게 정의될 수 있을까?^[[Increment (증분)](https://qlsjtmek2.github.io/posts/Increment-%EC%A6%9D%EB%B6%84/)]
...
> 
> $$
> = \int^\pi_{0} \int_{0}^{2\pi} \sin \theta d\theta d\phi= \left( \int_{0}^{\pi} \sin \theta d\theta \right) \left( \int_{0}^{2\pi} d\phi \right)
> $$
> 
> 
> $$
