...
tags: ["멀티 프로세스", "Fork", "자식 프로세스", "부모 프로세스", "좀비 프로세스", "Reaping", "wait()", "execl"]
math: true
toc: true
comments: true
---
...
![Pasted image 20240905171626.png](/assets/img/posts/Pasted image 20240905171626.png)
...
후에 자식 프로세스가 종료되면, 부모 프로세스가 이를 감지해서 [Reaping](https://qlsjtmek2.github.io/Reaping), 자원 할당 해제를 해줘야한다. 그렇지 않으면, 자식 프로세스가 [Zombie Process](https://qlsjtmek2.github.io/Zombie-Process)가 된다.
...
> 
> ![Pasted image 20240905173207.png](/assets/img/posts/Pasted image 20240905173207.png)
> 
...
> 
> ![Pasted image 20240905173435.png](/assets/img/posts/Pasted image 20240905173435.png)
> 
...
> 
> ![Pasted image 20240910165912.png](/assets/img/posts/Pasted image 20240910165912.png){: width="400"}
> 
> \<defunct> = 좀비 프로세스 상태
> 
...
만약 부모 프로세스가 Reaping을 하지 않은 채 종료된다면, [init process](https://qlsjtmek2.github.io/init-process)가 종료된 프로세스가 갖고있던 자식 프로세스를 자동으로 Reaping해준다.
