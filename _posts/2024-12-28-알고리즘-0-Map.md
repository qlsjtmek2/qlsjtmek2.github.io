...
title: "알고리즘 0. Map"
date: "2024-12-28"
categories: ["Atlas", "Blog Posts", "IT", "알고리즘"]
...
[알고리즘이란, 문제의 모든 경우를 일반적으로 해결하는 방법이다.](https://qlsjtmek2.github.io/알고리즘이란,-문제의-모든-경우를-일반적으로-해결하는-방법이다.) 따라서 대부분의 알고리즘에서는 모든 경우를 다 따져야 한다. 얼마나 효율적이게 따지냐에 따라서 알고리즘 성능이 갈리고, 효율적이게 따지는 '기법'들이 많이 있다.
...
- Basic Data Structures
	- Array
	- [Linked List](https://qlsjtmek2.github.io/Linked-List)
	- [Queue (큐)](https://qlsjtmek2.github.io/Queue-(큐))
	- [Stack (스택)](https://qlsjtmek2.github.io/Stack-(스택))
	- [Priority Queue (우선순위 큐)](https://qlsjtmek2.github.io/Priority-Queue-(우선순위-큐))
	- Tree
		- [Binary Search Tree](https://qlsjtmek2.github.io/Binary-Search-Tree)
		- [AVL Tree](https://qlsjtmek2.github.io/AVL-Tree)
		- [Parsing Tree](https://qlsjtmek2.github.io/Parsing-Tree)
		- [Red-Black Tree](https://qlsjtmek2.github.io/Red-Black-Tree)
	- Graph
	- [Trie](https://qlsjtmek2.github.io/Trie)
	- [Union-Find Sets (Disjoint Sets)](https://qlsjtmek2.github.io/Union-Find-Sets-(Disjoint-Sets))
	- [Hash Table](https://qlsjtmek2.github.io/Hash-Table)
- Basic Algorithms
	- Sorting
...
> [!example]- > sum(x) = 1 + 2 + ... + x 함수 증명{title}
