...
> 
> 
> 위 과정에서 '[구간이 아주 작은 적분은, 그냥 dx를 곱한것과 같다.](https://qlsjtmek2.github.io/posts/구간이-아주-작은-적분은-그냥-dx를-곱한것과-같다)' 를 사용한다. 따라서 $$\displaystyle \oint_{\Box} \mathbf{F} \cdot d\mathbf{r} = \left(\frac{\partial F_y}{\partial x} - \frac{\partial F_x}{\partial y}\right) \, dx \, dy$$
> 결론을 얻는다.
> 
