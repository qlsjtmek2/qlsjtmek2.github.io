...
tags: ["선적분", "면적분", "기울기", "회전", "발산", "그린의 정리", "스톡스의 정리", "보존 벡터장"]
math: true
toc: true
comments: true
---
...
Spline^[[Obsidian과 Git Blog 연동하기](https://qlsjtmek2.github.io/posts/Obsidian%EA%B3%BC-Git-Blog-%EC%97%B0%EB%8F%99%ED%95%98%EA%B8%B0)]
