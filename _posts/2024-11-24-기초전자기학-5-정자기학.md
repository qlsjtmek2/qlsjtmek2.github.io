...
tags: ["전류", "전하 밀도", "로렌츠 힘 법칙", "자기장", "앙페르 법칙", "벡터 포텐셜", "자기 쌍극자 모멘트", "연속 방정식"]
math: true
toc: true
comments: true
---
...
![Pasted image 20241207182144.png](/assets/img/posts/Pasted image 20241207182144.png)
...
![Pasted image 20241207210430.png](/assets/img/posts/Pasted image 20241207210430.png){: width="500"}
...
![Pasted image 20241208141530.png](/assets/img/posts/Pasted image 20241208141530.png){: width="400"}
...
![Pasted image 20241208144200.png](/assets/img/posts/Pasted image 20241208144200.png){: width="400"}

다중극 전개를 적용할 문제 상황을 위 그림과 같이 가정하자. Steady Current I가 흐르는 닫힌 도선을 멀리 바라보는 상황이다. 이때 벡터 전위는 다음과 같다. $\displaystyle \vec{A}(\vec{r}) = \frac{\mu_{0}}{4\pi} \oint_{C} \frac{\vec{I}}{\eta}dl' = \frac{\mu_{0}I}{4\pi} \oint_{C} \frac{d\vec{l}'}{\eta}$
...
![Pasted image 20241208154617.png](/assets/img/posts/Pasted image 20241208154617.png){: width="500"}
...
![Pasted image 20241208155251.png](/assets/img/posts/Pasted image 20241208155251.png)
