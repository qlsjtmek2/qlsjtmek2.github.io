...
![image](/assets/img/posts/Pasted image 20241009182653.png){: width="300"}
...
![image](/assets/img/posts/Pasted image 20241009183553.png){: width="400"}

그림을 그려보면, 가운데 값보다 확실히 작은 값은 왼쪽 위 빨간색 영역이다. 가운데 값보다 확실히 큰 값은 오른쪽 아래 빨간색 영역이다. 나머지 부분은 클지 작을지 판단할 수 없는 부분.

![image](/assets/img/posts/Pasted image 20241009184547.png){: width="400"}
...
$\displaystyle \frac{{\frac{k}{2}-1 + 2 + 2\left( \frac{k}{2}-1 \right)}}{5k} = \frac{{ \frac{k}{2} + 1 + k -2 }}{5k}= \frac{{\frac{3}{2}k - 1}}{5k} = \frac{3}{10} - \frac{1}{5k} \simeq \frac{3}{10}$

2. 가운데가 $\frac{k+1}{2}$번 째
$\displaystyle \frac{{ \frac{k+1}{2}-1 + 2 + 2\left(  \frac{{k+1}}{2} -1  \right) }}{5k} = \frac{{ \frac{k}{2} + \frac{1}{2} + 1 + k + 1 - 2 }}{5k}= \frac{{\frac{3}{2k} + \frac{1}{2}}}{5k} = \frac{3}{10} + \frac{1}{10k} \simeq \frac{3}{10}$
...
![image](/assets/img/posts/Pasted image 20241017105006.png){: width="600"}
...
![image](/assets/img/posts/Pasted image 20241017105103.png){: width="600"}
...
![image](/assets/img/posts/Pasted image 20241010103018.png){: width="400"}
...
![image](/assets/img/posts/Pasted image 20241010092846.png){: width="400"}
...
![image](/assets/img/posts/Pasted image 20241010092735.png){: width="250"}
...
![image](/assets/img/posts/Pasted image 20241015101626.png)
...
![image](/assets/img/posts/Pasted image 20241015102638.png){: width="300"}
...
![image](/assets/img/posts/Pasted image 20241015141536.png){: width="600"}
...
![image](/assets/img/posts/GrahamScanDemo.gif){: width="200"}
...
![image](/assets/img/posts/Pasted image 20241015162125.png){: width="400"}

만약 점이 안쪽에 들어오면 Convex Hull이 바뀌지 않아도 된다.

![image](/assets/img/posts/Pasted image 20241015210942.png){: width="400"}

점이 밖에 들어오면 Convex Hull 모양이 바뀌어야 한다. 아이디어는, Convex Hull에 접선을 그려서, 접점과 새로운 점을 잇는다. 기존의 접점 사이에 있던 점은 다 버리면 된다.

![image](/assets/img/posts/Pasted image 20241015230227.png){: width="500"}
...
> 
> 
> ![image](/assets/img/posts/Pasted image 20241015230559.png){: width="400"}
> 
...
> 먼저 Successor.
> 
> ![image](/assets/img/posts/Pasted image 20241015231026.png){: width="350"}
> 
...
> 1. **접점이 두개** 생기는 경우
> 
> ![image](/assets/img/posts/Pasted image 20241015232414.png){: width="350"}
> 
...
> 2. **접점이 한개** 생기는 경우
> 
> ![image](/assets/img/posts/Pasted image 20241015233041.png){: width="400"}
> 
> $$x < m ~~~ || ~~~ x > M$$
> 인 경우, 접점이 한개 생긴다.
> 
...
![image](/assets/img/posts/Pasted image 20241015234007.jpg){: width="300"}
...
![image](/assets/img/posts/Pasted image 20241015094025.png)

> [!question]- 접점을 어떻게 찾아?{title}
> 똑같이 CCW로 찾으면 된다.
> 
> ![image](/assets/img/posts/Pasted image 20241015235529.png){: width="350"}
> 
...
> 
> ![image](/assets/img/posts/Pasted image 20241015235715.png){: width="350"}
> 
...
> ![image](/assets/img/posts/Pasted image 20241016085218.png){: width="350"}
> 
...
![image](/assets/img/posts/Pasted image 20241017215532.png){: width="400"}

그다음은, 2칸씩 짝지어서 더한다.

![image](/assets/img/posts/Pasted image 20241017215559.png)

그다음은, 4칸씩 짝지어서 더한다.

![image](/assets/img/posts/Pasted image 20241017215718.png)
