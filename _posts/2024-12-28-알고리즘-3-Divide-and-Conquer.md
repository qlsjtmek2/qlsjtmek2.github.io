...
[알고리즘 1. Basic Algorithm#Merge Sort](https://qlsjtmek2.github.io/posts/%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98-1-Basic-AlgorithmMerge-Sort/)가 Divide and Conquer 방법을 적용한 Sorting 방법이다. 
...
![Pasted image 20241009182653.png](/assets/img/posts/Pasted image 20241009182653.png){: width="300" .shadow}
...
![Pasted image 20241009183553.png](/assets/img/posts/Pasted image 20241009183553.png){: width="400" .shadow}

그림을 그려보면, 가운데 값보다 확실히 작은 값은 왼쪽 위 빨간색 영역이다. 가운데 값보다 확실히 큰 값은 오른쪽 아래 빨간색 영역이다. 나머지 부분은 클지 작을지 판단할 수 없는 부분.

![Pasted image 20241009184547.png](/assets/img/posts/Pasted image 20241009184547.png){: width="400" .shadow}
...
![Pasted image 20241017105006.png](/assets/img/posts/Pasted image 20241017105006.png){: width="600" .shadow}
...
![Pasted image 20241017105103.png](/assets/img/posts/Pasted image 20241017105103.png){: width="600" .shadow}
...
![Pasted image 20241010103018.png](/assets/img/posts/Pasted image 20241010103018.png){: width="400" .shadow}
...
![Pasted image 20241010092846.png](/assets/img/posts/Pasted image 20241010092846.png){: width="400" .shadow}
...
![Pasted image 20241010092735.png](/assets/img/posts/Pasted image 20241010092735.png){: width="250" .shadow}
...
![Pasted image 20241015101626.png](/assets/img/posts/Pasted image 20241015101626.png){: .shadow}
...
> ![Pasted image 20241016085218.png](/assets/img/posts/Pasted image 20241016085218.png){: width="350" .shadow}
> 
