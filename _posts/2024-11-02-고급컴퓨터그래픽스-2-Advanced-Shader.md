...
> 맞아. 쉐이더 프로그램을 전환하면, 내부적으로 **셰이더 상태**와 **유니폼 변수**들을 다시 설정해야 하기 때문에 오버헤드가 발생해.
> 
...
> ```
> 
> 만약, 모든 오브젝트가 하나의 쉐이더만 사용하는 경우
> 최초 한번만  glUseProgram(shader)를 사용하고, 매 Draw 과정에선 glDrawArrays만 사용하는게 더 효율적이다.
