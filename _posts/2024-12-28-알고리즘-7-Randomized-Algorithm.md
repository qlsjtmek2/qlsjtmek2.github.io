...
date: "2024-12-28"
categories: ["IT", "알고리즘"]
tags: ["랜더마이즈 알고리즘", "라스 베가스", "몬테 카를로", "LCA", "Binary Lifting", "Boruvka's MST Algorithm", "Randomized MST Algorithm", "소수 판정"]
math: true
toc: true
comments: true
---
...
![Pasted image 20241205093636.png](/assets/img/posts/Pasted image 20241205093636.png){: width="400" .shadow}
...
5. ![Pasted image 20241205094907.png](/assets/img/posts/Pasted image 20241205094907.png){: .shadow}
6. G'''를 알고리즘에 재귀적으로 넣어 나온 MST를 C'라고 하고, C와 C'를 합집합하면 답이다. (왜?)



![Pasted image 20241205095832.png](/assets/img/posts/Pasted image 20241205095832.png){: width="400" .shadow}

검은색은 이미 MST에 들어간 애들. 16인 Edge가 Heavy가 안될 확률은 아주 낮다. 다른 Edge가 모두 빠져야 Heavy가 안된다. 하나라도 들어가면 16이 Heavy Edge이다. 


![Pasted image 20241205094907.png](/assets/img/posts/Pasted image 20241205094907.png){: .shadow}
